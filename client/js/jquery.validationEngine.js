...
(function($) {
    ...
    var methods = {
        ...
        _funcCall: function(field, rules, i, options) {
            ...
            if(functionName.indexOf('.')>0) // avoid functionNames that start with dot
            {    
                var namespaces = functionName.split('.');
                var current = window;
                while(namespaces.length)
                {    
                    current = current[namespaces.shift()];
                }
				fn = current;
            }    
            else 
        ...
        */
        ...
        _closePrompt: function(field) {
			...
			field.parents('div.clearfix').removeClass('error');
        },
		...
		isRTL: function(field)
		{
			...
			var rtl =
				...
				($body.css('direction') || '').toLowerCase()==='rtl';
			return Boolean(rtl);
		},
        /**
